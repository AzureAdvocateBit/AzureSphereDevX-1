...
// Timers
static DX_TIMER periodicTimer = {.period = { 6, 0 }, .name = "periodicTimer", .handler = PeriodicHandler };
static DX_TIMER oneShotTimer = {.period = { 0, 0 }, .name = "oneShotTimer", .handler = oneShotHandler };
